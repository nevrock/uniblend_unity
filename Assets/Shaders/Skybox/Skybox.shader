Shader "Joseph&Minions/StylizedSkybox"
{
    Properties
    {
        ...
        _Brightness("Cloud Brightness",  Range(0, 10)) = 2.5
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (Varyings IN) : SV_TARGET
            {
                ...
                if (horizon < 0)
                {
                    gradientDay = lerp(_NightBottomColor.rgb, _NightTopColor.rgb, saturate(horizon));
                    gradientNight = lerp(_DayBottomColor.rgb, _DayTopColor.rgb, saturate(horizon));
                }
                ...
                float3 combined = skyGradients + sunAndMoon + stars + cloudsColored;
